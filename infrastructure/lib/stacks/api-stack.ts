  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    this.api = new appsync.GraphqlApi(this, 'API', {
      ...
      logConfig: {
        ...
        retention: props.environmentName === 'live' 
    ...
    transactionsDataSource.createResolver('ListTransactionsByInvestorResolver', {
      typeName: 'Query',
    ...
    notificationsDataSource.createResolver('ListNotificationsByInvestorResolver', {
      typeName: 'Query',
    ...
    // Developments resolvers
    developmentsDataSource.createResolver('ListDevelopmentsByPropertyResolver', {
      typeName: 'Query',
      fieldName: 'listDevelopmentsByProperty',
      requestMappingTemplate: appsync.MappingTemplate.fromString(`
        {
          "version": "2017-02-28",
          "operation": "Query",
